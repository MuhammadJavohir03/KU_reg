...
<body>
    <div class="container">
        ...
        <h1 class="bg-white text-danger p-2 mb-3 text-center shadow">
            Pullik A'rizaga topshirgan talabalar ro'yxati
        </h1>
        ...
        <form method="GET" class="row g-2 mb-3">
            ...
            <div class="col-md-4">
                ...
                <datalist id="guruhlar">
                    <?php
                    $groups = $pdo->query("SELECT DISTINCT guruh FROM pullik")->fetchAll();
                    foreach ($groups as $g) {
            ...
            <div class="col-md-3">
                <a href="export_pullik.php?guruh=<?= isset($_GET['guruh']) ? urlencode($_GET['guruh']) : '' ?>"
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                if (!empty($guruh)) {
                    $stmt = $pdo->prepare("SELECT * FROM pullik WHERE guruh LIKE :guruh");
                    $stmt->execute([
                        'guruh' => '%' . $guruh . '%'
                    ]);
                } else {
