...
<style>
    ...
    @media (max-width: 768px) {
        ...
        .chat-sidebar {
            width: 100%;
            display: <?= $section_id ? 'none' : 'flex' ?>;
        }

        .chat-main {
            display: <?= $section_id ? 'flex' : 'none' ?>;
            height: 100dvh;
        }
    ...
    <div class="chat-container">
        <div class="chat-sidebar">
            <div class="sidebar-header">
                <h1 class="h5 ms-4">Muloqotlar</h1>
            </div>
                    ...
                    <form method="POST" enctype="multipart/form-data" id="chatForm">
                        <div class="input-area">
                            <label style="cursor:pointer; margin-bottom:0;">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="#667781" viewBox="0 0 16 16">
