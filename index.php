            ...
            <div class="carousel-inner my-4">
                ...
                <div class="carousel-item active">
                    <div class="position-relative bg-dark opacity-50">
                        <a href="elon1.php">
                            <img src="Logos/bepul.jpg" class="d-block w-100" style="height:400px; object-fit:cover;" alt="...">
                        </a>

                    </div>
                    <div class="carousel-caption d-none d-md-block">
                        <h5>Qayta topshiruv bahorgi (bepul imkoniyat) maktabiga ariza berish boshlandi</h5>
